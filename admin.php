...
<?php
	...
	$sql = "SELECT prisijungimo_vardas,vartotojo_tipas,el_pastas,pask_prisijungimas "
            . "FROM " . TBL_USERS . " ORDER BY vartotojo_tipas DESC,prisijungimo_vardas";
