...
// pakeiciam slaptazodi DB
         ...
         $sql = "UPDATE ". TBL_USERS." SET slaptazodis='$passdb' WHERE prisijungimo_vardas='$user'";
...
// siunciam
$to      = $_SESSION['umail'];
$subject = "T120B145 IT projektas - laikinas slaptažodis";
$message = $user . ",\n\n"
...
<html>
    <head>
  	...
  	<body>
  		<table class="slaptazodis" ><tr><td></td></tr>
			<tr><td> 
       			<div align="center"> <font size="5" color="#000000"> Pakeistas slaptažodis vartotojui  <?php echo $_SESSION['name_login']; ?></font> <br> 
