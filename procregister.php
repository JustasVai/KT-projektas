...
{ header("Location: logout.php");exit;}
  ...
  $user=strtolower($_POST['Vvardas']);$_SESSION['name_login']=$user;//Vartotojo vardas
  $pass=$_POST['slaptazodis'];$_SESSION['pass_login']=$pass;//slaptazodis
  $mail=$_POST['epastas'];$_SESSION['mail_login']=$mail;//elpastas
  $name=$_POST['vardas'];$_SESSION['user_login']=$name;//vardas
  $surname=$_POST['pavarde'];$_SESSION['surname_login']=$surname;//pavarde
  $date=$_POST['data'];$_SESSION['date_login']=$date;//data
  ...
  $_SESSION['prev'] = "procregister";
		...
		{ // vardas  geras,  nuskaityti vartotoja is DB
		 ...
		 list($dbuname)=checkdb($user);  //patikrinam DBSS   
		 ...
		 $sql = "INSERT INTO " . TBL_USERS. " (vardas, pavarde, gimimo_data, prisijungimo_vardas, slaptazodis, regist_data, el_pastas, userid, vartotojo_tipas)
          VALUES ('$name','$surname','$date','$user','$pass', null,'$mail','$userid','$ulevel')";
